...
# Load image:
input_image = Image.open("circulos.png")
...
def canny_edge_detector(input_image):
    ...
    blurred = compute_blur(grayscaled, input_image.width, height)
    ...
    keep = filter_strong_edges(gradient, input_image.width, input_image.height, 20, 25)
    #print(gradient)
    print(type(gradient))
